...
<body>
    <div class="d-flex align-items-center vh-100 bg-dark">
        ...
        <?php else: ?>
            <form class="container-lg text-end shadow-lg rounded col-3 p-4 bg-light" id="login-form" action="./action-ej-3.php" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <input name="usuario" id="usuario" type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                ...
                <p class="text-start" id="password-error" style="color: red;">Usuario y/o contraseña incorrectos</p>
