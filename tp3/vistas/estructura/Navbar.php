<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <a class="navbar-brand" href="../../index.php" style="display:flex; flex-direction:row;">
        ...
        <h5 class="text-center p-4 ">Trabajo Práctico N°3</h5>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navegacion">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../vistas/eje1.php">Ejercicio 1</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../vistas/eje2.php">Ejercicio 2</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../vistas/eje3.php">Ejercicio 3</a>
            </li>
        </ul>
    </div>
</nav>