<nav class="navbar navbar-expand-lg navbar-dark bg-dark p-3">
    <a class="navbar-brand" href="../vistas/index.php" style="display:flex; flex-direction:row;">
    ...
    <div class="collapse navbar-collapse" id="navegacion">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="ej1.php">Ejercicio 1</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="ej5.php">Ejercicio 5</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="ej6.php">Ejercicio 6</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="ej7.php">Ejercicio 7</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="ej8.php">Ejercicio 8</a>
            </li>
        </ul>
    </div>
</nav>